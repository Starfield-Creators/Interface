package
{
   ...
   public class WeaponsCraftingMenu extends IMenu
   {
      ...
      public var InfoCard_mc:WeaponsInfoCard;
      ...
      public function WeaponsCraftingMenu()
      {
         ...
         this.ModelPreview_mc.ModelBounds_mc.SetBackgroundColor(218630143);
         ...
         DirectoryList_Entry.unselectedColor = CraftingUtils.WEAPONS_COLOR;
         ...
         _loc2_.EntryClassName = "WeaponsList_Entry";
         ...
         GlobalFunc.SetText(this.MenuBanner_mc.MenuBannerLabel_mc.Text_tf,"$WeaponWorkbench");
         ...
         GlobalFunc.SetText(this.InventoryHeaders_mc.DamageHeader_mc.Text_tf,"$dmg");
         ...
         this.ConfirmationPopup_mc.buttonBarColor = CraftingUtils.WEAPONS_COLOR;
      ...
      override public function onAddedToStage() : void
      {
         ...
         BSUIDataManager.Subscribe("PlayerWeaponsInventoryData",this.OnPlayerWeaponsInventoryDataUpdate);
      ...
      public function SetUpButtons() : void
      {
         ...
         this.ButtonBar_mc.ButtonBarColor = CraftingUtils.WEAPONS_COLOR;
      ...
      private function OnPlayerWeaponsInventoryDataUpdate(param1:FromClientDataEvent) : void
      {
      ...
      {
         GlobalFunc.PlayMenuSound("UIMenuCraftingModsMenuClose");
      ...
      private function slotsState(param1:int) : void
      {
         switch(param1)
         {
            case this.ENTER_STATE:
               ...
               break;
            case this.LIST_HOVER:
               if(this.SlotsList_mc.selectedEntry != null)
               {
                  BSUIDataManager.dispatchEvent(new CustomEvent(CraftingUtils.HIGHLIGHT_3D_EVENT,{"formID":this.SlotsList_mc.selectedEntry.uID}));
               }
               break;
            case this.LIST_PRESS:
            ...
            case this.CANCEL_BTN:
               ...
               BSUIDataManager.dispatchEvent(new Event(CraftingUtils.REVERT_HIGHLIGHT_EVENT));
      ...
      private function confirmingState(param1:int) : void
      {
         ...
         switch(param1)
         {
            case this.ENTER_STATE:
               ...
               if(this.RequirementsData != null && this.ModsList_mc.selectedEntry != null)
               {
                  this.ConfirmationPopup_mc.PopulateList(this.RequirementsData.aCostRequirements);
                  _loc2_ = "$$Installing " + this.ModsList_mc.selectedEntry.sName;
