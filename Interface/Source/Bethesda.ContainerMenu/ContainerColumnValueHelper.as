package
{
   ...
   public class ContainerColumnValueHelper
   {
      ...
      public static const VIEW_TYPE_AGGREGATE:int = EnumHelper.GetEnum();
      ...
      public function ContainerColumnValueHelper()
      {
         super();
      }
      ...
      public static function InitHelper() : void
      {
         ...
         if(ColumnInfoByType.length == 0)
         {
            ...
            ColumnInfoByType[VIEW_TYPE_AGGREGATE] = [{
               "headerText":"$InvCompareLabel_Value",
               "getSortValFunc":getItemValue,
               "displayValFunc":"DisplayItemVal",
               "sortType":InventoryItemUtils.SORT_VALUE
      ...
      public static function GetViewTypeFromFilterFlag(param1:int) : int
      {
         ...
         switch(param1)
         {
            ...
            case InventoryItemUtils.ICF_AID:
               ...
               break;
            case InventoryItemUtils.ICF_NEW_ITEMS:
            case InventoryItemUtils.ICF_ALL:
               _loc2_ = VIEW_TYPE_AGGREGATE;
         }
         return _loc2_;
      }
