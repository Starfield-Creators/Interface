package
{
   ...
   public class ContainerItem extends BSContainerEntry
   {
      ...
      public static var IsContainerItemList:Boolean = false;
      ...
      override public function SetEntryText(param1:Object) : void
      {
         ...
         this.StolenIcon_mc.visible = !param1.bContraband && (IsStealing && IsContainerItemList || Boolean(param1.bStolen));
         ...
         var _loc4_:String = ContainerColumnValueHelper.GetColumnDisplayFuncName(CurrFilter);
         if(this[_loc4_] != undefined)
         {
            this[ContainerColumnValueHelper.GetColumnDisplayFuncName(CurrFilter)](param1);
         }
         else
         {
            GlobalFunc.SetText(this.Compare_tf,param1.uValue.toString());
