package
{
   ...
   public class DrugsCraftingMenu extends IMenu
   {
      ...
      public function DrugsCraftingMenu()
      {
         this.TrackButtonData = new ButtonBaseData("$TRACK",new UserEventData("XButton",this.ToggleTracking),false);
         super();
         this.ModelPreview_mc.ModelBounds_mc.SetBackgroundColor(202448256);
         ...
         this.ConfirmationPopup_mc.buttonBarColor = CraftingUtils.DRUGS_COLOR;
      ...
      private function get TypeHeader_mc() : MovieClip
      {
         return this.DirectoryHolder_mc.TypeHeader_mc;
      }
      ...
      public function SetUpButtons() : void
      {
         ...
         this.ButtonBar_mc.ButtonBarColor = CraftingUtils.DRUGS_COLOR;
      ...
      private function ConfirmBuild() : void
      {
         ...
         GlobalFunc.PlayMenuSound("UIMenuCraftingDrugsMenuRequirements");
      ...
      {
         GlobalFunc.PlayMenuSound("UIMenuCraftingDrugsMenuClose");
