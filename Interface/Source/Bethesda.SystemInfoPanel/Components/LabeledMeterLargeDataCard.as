package Components
{
   ...
   public class LabeledMeterLargeDataCard extends MovieClip
   {
      ...
      private var TargetFillValue:Number = 0;
      ...
      public function LabeledMeterLargeDataCard()
      {
      ...
      public function SetColorConfig(param1:LabeledMeterColorConfig) : *
      {
         ...
         var _loc2_:Number = this.MaxValue != 0 ? this.TargetFillValue / this.MaxValue : 0;
      ...
      private function SetMaxText() : *
      {
         switch(this.CurrentMode)
         {
            ...
            case MODE_WEIGHT:
               ...
               if(this.Weight_mc != null)
               {
                  this.Weight_mc.visible = this.TargetFillValue > this.MaxValue;
      ...
      {
         var _loc1_:String = "/" + GlobalFunc.FormatNumberToString(this.MaxValue,this.LabelPrecision);
         var _loc2_:* = GlobalFunc.FormatNumberToString(this.TargetFillValue,this.LabelPrecision);
         if(this.TargetFillValue > this.MaxValue)
         {
            _loc2_ = "<font color=\"#" + ColorUtils.UIntToHex(this.ColorConfig.CurrTextOverflow) + "\">" + _loc2_ + "</font>";
         }
      ...
      private function SetCurrentText() : void
      {
         switch(this.CurrentMode)
         {
            case MODE_DEFAULT:
               ...
               {
                  this.SetText(this.Current_tf,this.TargetFillValue);
               }
               break;
            case MODE_WEIGHT:
               if(this.TargetDeltaValue != 0)
      ...
      public function SetMaxValue(param1:int, param2:String = null) : void
      {
         ...
         if(!this.InitializedMaxValue || param1 != this.MaxValue)
         {
            ...
            _loc3_ = this.CurrentFillValue;
            _loc4_ = this.CurrentDeltaValue;
            ...
            this.SetMaxText();
            this.UpdatePercent(_loc3_,_loc4_,true);
         }
      }
      ...
      private function UpdateFillGeometry() : *
      {
         ...
         var _loc2_:Number = this.MaxValue != 0 ? this.CurrentDeltaValue / this.MaxValue : 0;
         ...
         var _loc3_:Number = this.Background_mc.width * _loc1_;
         if(_loc1_ != 0)
         {
         ...
         if(_loc2_ != 0)
         {
            this.DeltaBarClip.graphics.beginFill(this.DeltaBarColor);
            this.DeltaBarClip.graphics.drawRect(_loc3_,0,this.Background_mc.width * Math.min(_loc2_,1 - _loc1_),this.Background_mc.height);
            this.DeltaBarClip.graphics.endFill();
         }
      }
      ...
      private function UpdatePercent(param1:Number, param2:Number, param3:Boolean) : void
      {
         ...
         this.TargetFillValue = afCurrentValue;
         ...
         if(abImmediate)
         {
            ...
            this.CurrentFillValue = this.TargetFillValue;
