package
{
   ...
   public class BarterCategory extends BSContainerEntry
   {
      ...
      public var DisabledTypeIcon_mc:MovieClip;
      ...
      {
         return this.Title_mc.Text_mc.Text_tf;
      }
      
      private function get Count_tf() : TextField
      {
         return this.Count_mc.Text_mc.Text_tf;
      }
      
      private function get Subtitle_tf() : TextField
      {
         return this.Subtitle_mc.Text_mc.Text_tf;
      }
      ...
      override public function SetEntryText(param1:Object) : void
      {
         ...
         this.DisabledTypeIcon_mc.gotoAndStop(this.GetIconFrameFromFilter(param1.iFilterFlags));
         var _loc2_:* = param1.uTotalItemCount > 0;
         this.TypeIcon_mc.visible = _loc2_;
         this.DisabledTypeIcon_mc.visible = !_loc2_;
         this.Title_mc.gotoAndStop(_loc2_ ? "Normal" : "Disabled");
         this.Subtitle_mc.gotoAndStop(_loc2_ ? "Normal" : "Disabled");
         this.Count_mc.gotoAndStop(_loc2_ ? "Normal" : "Disabled");
         super.SetEntryText(param1);
         GlobalFunc.SetText(this.Count_tf,param1.uTotalItemCount.toString());
         if(param1.sSubtitle != null)
         {
            GlobalFunc.SetText(this.Subtitle_tf,param1.sSubtitle,false,false,CharactersPerLine);
         }
         else
         {
      ...
      private function GetIconFrameFromFilter(param1:int) : String
      {
         ...
         if(param1 == InventoryItemUtils.ICF_NEW_ITEMS || param1 == InventoryItemUtils.ICF_BUY_BACK)
         {
            _loc2_ = "New";
         }
