package
{
   ...
   public class BarterItem extends BSContainerEntry
   {
      ...
      public static var PlayerFunds:uint = 0;
      
      public static var IsVendorItemList:Boolean = false;
      ...
      public function BarterItem()
      {
         ...
         maxCharactersToDisplay = LargeTextMode ? 18 : 22;
         twoLineText = true;
      }
      ...
      {
         return this.CompareValue_mc.Text_mc.Text_tf;
      }
      ...
      override public function SetEntryText(param1:Object) : void
      {
         ...
         if(!IsVendorItemList)
         {
            this.Name_mc.gotoAndStop("Normal");
            this.Count_mc.gotoAndStop("Normal");
            this.CompareValue_mc.gotoAndStop("Normal");
         }
         else
         {
            _loc5_ = PlayerFunds < param1.uValue ? "Disabled" : "Normal";
            this.Name_mc.gotoAndStop(_loc5_);
            this.Count_mc.gotoAndStop(_loc5_);
            this.CompareValue_mc.gotoAndStop(_loc5_);
         }
         ...
         {
            _loc6_ = this.Count_tf.getLineMetrics(0);
            _loc3_ -= _loc6_.width + _loc2_;
         }
         ...
         var _loc4_:String = BarterColumnValueHelper.GetColumnDisplayFuncName(CurrFilter);
         if(this[_loc4_] != undefined)
         {
            this[BarterColumnValueHelper.GetColumnDisplayFuncName(CurrFilter)](param1);
         }
         else
         {
