package
{
   ...
   public class FoodCraftingMenu extends IMenu
   {
      ...
      public function FoodCraftingMenu()
      {
         ...
         DirectoryList_Entry.unselectedColor = CraftingUtils.FOOD_COLOR;
         DirectoryList_Entry.selectedColor = CraftingUtils.SELECTED_TEXT_COLOR_DARK;
         DirectoryList_Entry.dimmedColor = CraftingUtils.FOOD_SECONDARY_COLOR;
         ...
         GlobalFunc.SetText(this.MenuBanner_mc.MenuBannerLabel_mc.Text_tf,"$CookingStation");
         ...
         this.ConfirmationPopup_mc.buttonBarColor = CraftingUtils.FOOD_COLOR;
      ...
      public function SetUpButtons() : void
      {
         ...
         this.ButtonBar_mc.ButtonBarColor = CraftingUtils.FOOD_COLOR;
      ...
      private function ConfirmBuild() : void
      {
         ...
         GlobalFunc.PlayMenuSound("UIMenuCraftingFoodMenuRequirements");
      ...
      {
         GlobalFunc.PlayMenuSound("UIMenuCraftingFoodMenuClose");
